...
func NewUnlockUserParams() *UnlockUserParams {
	return NewUnlockUserParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [UnlockUserParams].
...
type UnlockUserParams struct {
	...
	/* UserID.
	   ...
	   Unique ID of the user account to unlock (required).
	*/
	UserID string
...
// WithDefaults hydrates default values in the unlock user params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *UnlockUserParams) WithDefaults() *UnlockUserParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the unlock user params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *UnlockUserParams) SetDefaults() {
