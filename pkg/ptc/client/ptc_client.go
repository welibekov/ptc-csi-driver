...
// NewHTTPClient creates a new ptc HTTP client.
func NewHTTPClient(formats strfmt.Registry) *Ptc {
	return NewHTTPClientWithConfig(formats, nil)
}

// NewHTTPClientWithConfig creates a new ptc HTTP client,
// using a customizable transport config.
func NewHTTPClientWithConfig(formats strfmt.Registry, cfg *TransportConfig) *Ptc {
...
// New creates a new ptc client.
func New(transport runtime.ContextualTransport, formats strfmt.Registry) *Ptc {
	// ensure nullable parameters have default
	if formats == nil {
...
func (c *Ptc) SetTransport(transport runtime.ContextualTransport) {
